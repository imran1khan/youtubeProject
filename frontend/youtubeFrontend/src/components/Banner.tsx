    ...
    <div id="YTbanner" className="bg-gray-500 h-16 sticky top-0 z-10 flex justify-between">
      <div id="logoAndMenu" className=" flex justify-center items-center">
        <div className="flex gap-4 p-4">
          <div id="menuSvg">
            <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer block w-full h-full" height="24" viewBox="0 0 24 24" width="24" focusable="false" ><path d="M21 6H3V5h18v1zm0 5H3v1h18v-1zm0 6H3v1h18v-1z" fill="white"></path></svg>
          </div>
          <div id="youtubeLogo" className="h-7">
            <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer block w-full h-full" viewBox="0 0 90 20" focusable="false">
          ...
          <div className="flex gap-2 w-1/2 justify-center">
            ...
            <div>
              <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <path d="m20.87 20.17-5.59-5.59C16.35 13.35 17 11.75 17 10c0-3.87-3.13-7-7-7s-7 3.13-7 7 3.13 7 7 7c1.75 0 3.35-.65 4.58-1.71l5.59 5.59.7-.71zM10 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z" fill="white"></path></svg>
            </div>
          </div>
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false" className="cursor-pointer block w-full h-full"><path d="M12 3c-1.66 0-3 1.37-3 3.07v5.86c0 1.7 1.34 3.07 3 3.07s3-1.37 3-3.07V6.07C15 4.37 13.66 3 12 3zm6.5 9h-1c0 3.03-2.47 5.5-5.5 5.5S6.5 15.03 6.5 12h-1c0 3.24 2.39 5.93 5.5 6.41V21h2v-2.59c3.11-.48 5.5-3.17 5.5-6.41z" fill="white"></path></svg>
          </div>
        </div>
      </div>
      <div id="userSection" className=" flex justify-center items-center">
        <div className="flex gap-8 m-5">
          ...
          <div onClick={()=>{setDDMprofile((prev)=>!prev)}}>
            <img id="img" draggable="false" className="rounded-full cursor-pointer" alt="Avatar image" height="32" width="32" src="https://yt3.ggpht.com/DX89GV9x1g6YHtbRRTMSF4GTw4zxELXvtVyCO-y9EKZbEMtGc1T-oaATulWnG466IyVYoz6f=s88-c-k-c0x00ffffff-no-rj" />
            {ddmProfile&&<DDMenuProfile/>}
          </div>
        </div>
      </div>
    </div>
